  ...
  return (
      ...
      <tr>
            ...
            <td className='border border-gray-400 px-4 py-4 flex justify-center gap-4'>
              ...
              <button className='border p-1 px-3 bg-green-500 hover:bg-green-600 rounded-xl'>Update</button>
              <button className='border p-1 px-3 bg-red-500 hover:bg-red-600 rounded-xl'>Delete</button>
